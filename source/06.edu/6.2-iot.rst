...
下面以手机为例。现在已经有很多MQTT客户端可以直接发送消息，也可以通过APP Inventor 2 来封装功能。更多案例可以访问https://siot.readthedocs.io了解。

安卓手机可以安装MQTT Client，可以在http://www.mdpda.com/app/apk7623192.html下载。
